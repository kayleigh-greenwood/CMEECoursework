...
\newpage
	...
	% One of the most relevant aspects of overexploitation is deforestation, which is (maybe remove this part depending on methods) already represented in the variable used for land use change.
	...
	\addcontentsline{toc}{section}{Results}
	 ...
	 % better figure captions ! explain colours and grey
	...
	\begin{center}
		...
		\captionof{figure}{Biodiversity sensitivity to greenhouse gas emissions: country sensitivity scores grouped by continent. \textmd{There are 40 countries included, and their distribution between continents is as follows, 3 (Asia), 28 (Europe), 1 (North America), 2 (Oceania), 6 (South America).}}
...
\newpage
	...
	\begin{center}
		...
		\captionof{figure}{Biodiversity sensitivity to built-up land use: country sensitivity scores grouped by continent. \textmd{There are 164 countries included, and their distribution between continents is as follows, 51 (Africa), 35 (Asia), 37 (Europe), 3 (North America), 7 (Oceania), 31 (South America)}}
