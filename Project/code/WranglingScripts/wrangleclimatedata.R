# set wd
setwd("~/CMEECoursework/Project/data/RawDataFiles/WorldBankClimateData/rawcountrytemp/")
rm(list=ls())
library("rjson")
library("stringr")
library(dplyr)
...
files = c()
files <- list.files(path="~/CMEECoursework/Project/data/RawDataFiles/WorldBankClimateData/rawcountrytemp", pattern="*.csv", full.names=FALSE, recursive=FALSE)
