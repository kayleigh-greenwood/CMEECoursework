...
\newpage
	...
	%change layout of this para if I have time
	...
	158 countries and 18 years matched between the climate and biodiversity datasets. The sensitivity scores of countries to climate change had a mean of -0.016 (SD 0.0037, range: -0.24 - 0.078, n = 158), meaning for each increase in the average temperature of $1^\circ C$, the average country's BII decreases by 0.016. \autoref{figure:climatebox} groups  country-level climate sensitivity scores by continent and \autoref{figure:climatemap} shows their geographical distribution. 
	
	\begin{minipage}{\textwidth}
		\centering
		\includegraphics[width=6in]{../Images/ClimateSensitivityBoxplot.pdf}
		\captionof{figure}{Biodiversity sensitivity to climate change: country sensitivity scores grouped by continent. \textmd{Sensitivity scores represent the change in a country's BII in response to a  $1^\circ C$ increase in that country's average annual temperature. There are 158 countries included, and their distribution between continents is as follows, 47 (Africa), 36 (Asia), 36 (Europe), 2 (North America), 8 (Oceania), 29 (South America). I investigated the extreme lone outlier of Oceania, which was Fiji (-0.079), and there was no reason to exclude this country from the data as its' standard error was within the range of other countries in Oceania.}}
	...
	\centering
		...
		\captionof{figure}{Biodiversity sensitivity to climate change: distribution of country sensitivity scores. \textmd{ Sensitivity scores represent the change in a country's BII in response to a  $1^\circ C$ increase in that country's average annual temperature. Purple represents countries where temperature increases have negative impacts on biodiversity, orange countries represent countries where temperature increases have positive impacts on biodiversity. The more concentrated each colour is, the more sensitive that country's biodiversity is to changes in temperature. Dark grey represents countries for which there was no data.}}
	...
	\centering
		...
		\captionof{figure}{Biodiversity sensitivity to pollution. \textmd{ Sensitivity scores represent the change in a country's BII in response to a thousand-tonne increase of that country's annual CO2 equivalent emissions. Purple represents countries where emissions increases have negative impacts on biodiversity, orange countries represent countries where emissions increases have positive impacts on biodiversity. The more concentrated each colour is, the more sensitive that country's biodiversity is to changes in emissions. Dark grey represents countries for which there was no data.}}
...
\bigskip
	...
	175 countries and 3 years matched between datasets. Sensitivity scores of Europe, Oceania and South America each had extreme lone outliers which were removed. Europe's outlier was Ireland (2.756) which had a standard error of 2.108, which was 100x that of the next highest standard error in Europe. Although these high standard errors are already accounted for in the model, I removed Ireland due to the scale of difference from the rest of the data within Europe. South America's outlier was Honduras (-3.223) with a standard error of 2.466. Due to the standard error of Honduras being 1000x that of the next highest standard error of South American countries, Honduras was also excluded. Oceania's outlier was Samoa with a standard error of 2.344, which was 100x larger than that of the next highest standard error in Oceania, and therefore was removed.
	 ...
	 The sensitivity scores of remaining countries (n = 172) to built-up land had a mean of -0.0006 (SE 0.0009, range: -0.12 to 0.07), so for each square kilometre increase in built-up land area, the average country's BII decreases by 0.0006. \autoref{fig:landusebox} groups  country-level built-up land sensitivity scores by continent, and \autoref{fig:landusemap} shows their geographical distribution.
	
	\begin{minipage}{\textwidth}
	\centering
		\includegraphics[width=7in]{../Images/LandUseSensitivityBoxplot.pdf}
		\captionof{figure}{Biodiversity sensitivity to built-up land use: country sensitivity scores grouped by continent. \textmd{Sensitivity scores represent the change in a country's BII in response to a square kilometre increase in annual built-up land area. There are 172 countries included, and their distribution between continents is as follows, 52 (Africa), 42 (Asia), 37 (Europe), 3 (North America), 7 (Oceania), 31 (South America).}}
	...
	\centering
		...
		\captionof{figure}{Biodiversity sensitivity to build up land. \textmd{Sensitivity scores represent the change in a country's BII in response to a square kilometre increase in annual built-up land area. Purple represents countries where built-up land increases have negative impacts on biodiversity, orange countries represent countries where built-up land increases have positive impacts on biodiversity. The more concentrated each colour is, the more sensitive that country's biodiversity is to changes in built-up land. Dark grey represents countries for which there was no data.}}
...
\newpage
	...
	\centering
		...
		\captionof{figure}{Biodiversity sensitivity to invasive species: country sensitivity scores grouped by continent. \textmd{Sensitivity scores represent the change in a country's BII in response to an increase of 1 invasive species annually. There are 93 countries included, and their distribution between continents is as follows, 11 (Africa), 23 (Asia), 33 (Europe), 1 (North America), 5 (Oceania), 20 (South America). Extreme lone outliers include Bosnia and Herzegovina (0.041) for Europe and Malawi (0.055) for Africa, both of which were kept in for modelling.}}
		\label{invasivebox}
	\end{minipage}
	...
	\centering	
		...
		\captionof{figure}{Biodiversity sensitivity to Invasive species.\textmd{Sensitivity scores represent the change in a country's BII in response to an increase of 1 invasive species annually. Purple represents countries where invasive species increases have negative impacts on biodiversity, orange countries represent countries where invasive species increases have positive impacts on biodiversity. The more concentrated each colour is, the more sensitive that country's biodiversity is to changes in built-up land. Dark grey represents countries for which there was no data.}}
		\label{invasivemap}
	\end{minipage}
\newpage
	...
	\begin{table}[H]
		\begin{center}
			...
			\begin{tabular}{l|r|r|r|r} % <-- Alignments: 1st column left, 2nd middle and 3rd right, with vertical lines in between
				Variable & $\beta$ & \textit{SE} & \textit{t} & \textit{p}\\
				\hline
				Intercept (reference: Europe) & $<$ -0.001 & $<$ 0.001 & -0.682 & 0.497\\
				Africa & $<$ 0.001 & $<$ 0.001 & 0.682 & 0.497\\
				Asia & $<$ 0.001 & $<$ 0.001 & 0.682 & 0.497 \\
				North America & $<$ 0.001 & 0.002 & 0.509 & 0.612\\
				Oceania & $<$ -0.001 & $<$ 0.001 & -0.217 & 0.829\\
				South America & $<$ 0.001 & $<$ 0.001 & 0.881 & 0.381\\
