...
tapply(genome$BodyWeight, genome$Suborder, mean) 
  # take a quick mean
  # didnt work for columns that had NA in them
  # many R functions refuse to use variables containing missing data
...
plot(density(genome$GenomeSize, bw=0.1))
  # bw determines bandwidth (how coarsely/finely the data is displayed)
