...
cluster_run(speciation_rate, size, wall_time=0.5, interval_rich=1, interval_oct = (size/10), burn_in_generations = (8*size), output_file_name = paste("resultiter", iter, ".rda", sep=""))
